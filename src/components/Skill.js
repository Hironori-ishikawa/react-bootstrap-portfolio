        ...
        <div class="text-center">
          ...
          <div class="row text-center">
            ...
            <div class="col-md-3 services">
              <img src={NextJsImage} alt='NextJsアイコン' className='NextJsImage' />
              <h3 className='SkillNextJs'>Next.js</h3>
              <p className='SkillNextJsText'>Next.js学習中です</p>

            </div>
            <div class="col-md-3 services">
              <img src={reactImage} alt='reactアイコン' className='reactImage' />
              <h3 className='SkillReact'>React</h3>
              <p className='SkillReactText'>Reactがつかえます</p>
            </div>

            <div class="col-md-3 services">
              <img src={PhpImage} alt='Phpアイコン' className='PhpImage' />
